...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('delegations/departments/{delegation}', 'DelegationController@index_departments_delegation')->name('departments.index_departments_delegation')->middleware('permission:index_departments_delegation');
